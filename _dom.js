$each = function(cls, cb) { cls.startsWith('.') ? Array.prototype.forEach.call(document.getElementsByClassName(cls.substring(1)), cb) : Array.prototype.forEach.call(document.getElementsByTagName(cls), cb); }
...
$ready = function(fn) { var r = document.readyState; ( r === 'interactive' || r === 'complete' ) ? fn() : document.addEventListener('DOMContentLoaded', fn, false); };